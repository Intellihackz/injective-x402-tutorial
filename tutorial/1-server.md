...
If you haven't set up your environment yet, return to the [Main Tutorial](0-setup.md).
...
As a reminder, the facilitator is responsible for verifying the cryptographic signatures and broadcasting the actual transaction to the blockchain, paying the INJ gas fee on the buyer's behalf. By using the `@injectivelabs/x402` SDK, you get all of this complex blockchain infrastructure out-of-the-box without having to build it yourself!
...
[Next: Part 2 - Building the Frontend →](2-frontend.md)
